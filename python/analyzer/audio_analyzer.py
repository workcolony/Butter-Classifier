...
def analyze_file(filepath, bpm_override=None):
    ...
    # Plain Python floats required: this essentia build rejects np.float32
    # lists for BeatsLoudness' beats parameter ("cannot convert ... VECTOR_REAL").
    corrected_onsets = [float(onset * sr_factor) for onset in onsets]
